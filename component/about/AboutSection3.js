        ...
        <div className="row">
          ...
          <div className="col-xl-6 col-lg-6 wow fadeInRight">
            <div className="tf__about_2_text">
              ...
              <p>
              Your Source for Comprehensive Health Education Training.
              </p>
              <ul>
                <li>
                  <div className="icon">
                  ...
                  <div className="text">
                    <h4>Our Mission</h4>
                    <p>
                    Guiding individuals on their journey to optimal well-being through comprehensive and personalized health training programs                    </p>
                  </div>
                </li>
                <li>
                  <div className="icon">
                  ...
                  <div className="text">
                    ...
                    <p>
                    Our team consists of certified health experts passionate about sharing their knowledge and empowering others to lead healthier lives.                    </p>
                  </div>
                </li>
                <li>
                  <div className="icon">
                  ...
                  <div className="text">
                    ...
                    <p>
                    Offering up-to-date and evidence-based training content to stay at the forefront of health education.                    </p>
                  </div>
                </li>
                <li>
                  <div className="icon">
                  ...
                  <div className="text">
                    ...
                    <p>
                    Embracing innovative teaching methods and technology to enhance the learning experience for our clients.</p>                  </div>
                </li>
              </ul>
            </div>
          </div>
